...
# queryT: Probability of query to query transition, default=0.9999
# nullT: Probability of null to null transition, default=0.9999
...
### Example:
# testmodel = train(querydir='./counts/repeatA.dict', nulldir='./counts/all_lncRNA.dict', kvec='4', alphabet='ATCG', queryT=0.9999, nullT=0.9999, queryPrefix='query', nullPrefix='null', outputdir='./')
